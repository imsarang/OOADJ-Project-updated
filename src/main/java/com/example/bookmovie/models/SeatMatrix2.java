...
public class SeatMatrix2 {
    ...
    public String toString() {
        return "SeatMatrix2 [S_No=" + S_No + ", A=" + A + ", B=" + B + ", C=" + C + ", D=" + D + ", E=" + E + ", F=" + F
    ...
    public SeatMatrix2(Integer s_No, Integer a, Integer b, Integer c, Integer d, Integer e, Integer f, Integer g,
