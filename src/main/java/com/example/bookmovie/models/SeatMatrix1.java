...
public class SeatMatrix1 {
    ...
    public SeatMatrix1(Integer s_No, Integer a, Integer b, Integer c, Integer d, Integer e, Integer f, Integer g,
    ...
    public String toString() {
        return "SeatMatrix1 [S_No=" + S_No + ", A=" + A + ", B=" + B + ", C=" + C + ", D=" + D + ", E=" + E + ", F=" + F
